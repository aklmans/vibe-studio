...
export const dict = {
  zh: {
    ...
    // ─── cmdk items ──────────────────────────────────────────────────
    "cmdk.tab.overlay": "跳到 Overlay",
    "cmdk.tab.cover": "跳到 Cover",
    "cmdk.tab.poster": "跳到 Poster",
    "cmdk.tab.wallpaper": "跳到 Wallpaper",
    ...
    // ─── Export ───────────────────────────────────────────────────────
    "export.overlay": "导出 Overlay",
    "export.cover": "导出 Cover",
    "export.poster": "导出 Poster",
    "export.wallpaper": "导出壁纸集",
    "export.fullOverlay": "完整 Overlay PNG",
