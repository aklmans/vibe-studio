...
export const dict = {
  zh: {
    ...
    "manualSettings.searchPlaceholder": "搜索设置…",
    ...
    "agent.openJsonToImport": "打开 JSON 导入",
    "agent.reviewInJson": "在 JSON 中检查",
  ...
  en: {
    ...
    "manualSettings.searchPlaceholder": "Search settings…",
    ...
    "agent.openJsonToImport": "Open JSON to import",
