...
export function buildAgentPrompt(
  ...
  return [
    ...
    "  sections: [{ title, minutes?, speaker?, speakerLines?: string[], bullets?: string[] }] }",
    ...
    "speaker is the optional per-section presenter/guest name — lecture layouts introduce the active section's speaker; speakerLines are that speaker's role/affiliation/achievement lines (short, one point each). Only set them when the brief provides them.",
