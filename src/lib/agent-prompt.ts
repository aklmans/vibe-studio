...
export function buildAgentPrompt(
  ...
  return [
    ...
    "  sections: [{ title, minutes?, speaker?, bullets?: string[] }] }",
    ...
    "speaker is the optional per-section presenter/guest name — lecture layouts introduce the active section's speaker. Only set it when the brief names one.",
