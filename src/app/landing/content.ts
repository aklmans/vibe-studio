...
function galleryImagesForLocale(locale: Locale): ReadonlyArray<SurfaceGalleryImage> {
  if (locale === "zh") {
    return [
      ...
      {
        darkSrc: "/product/vibe-coding-overlay-vertical-dark.png",
        lightSrc: "/product/vibe-coding-overlay-vertical-light.png",
        alt: "Vibe Studio 竖屏合成画面导出",
        width: 1080,
        height: 1920,
        label: "竖屏合成画面 · 1080×1920",
      },
      {
  ...
  return [
    ...
    },
    {
      darkSrc: "/product/vibe-coding-overlay-vertical-dark.png",
      lightSrc: "/product/vibe-coding-overlay-vertical-light.png",
      alt: "Vibe Studio vertical overlay export",
      width: 1080,
      height: 1920,
      label: "Vertical overlay · 1080×1920",
    },
    {
      darkSrc: "/product/vibe-coding-wallpaper-desktop-4k-dark.png",
      lightSrc: "/product/vibe-coding-wallpaper-desktop-4k-light.png",
